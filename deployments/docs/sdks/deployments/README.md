...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetDeploymentEventsRequest](../../models/operations/getdeploymenteventsrequest.md)                                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
async function run() {
  const result = await sdk.deployments.getDeployment("dpl_89qyp1cskzkLrVicDaZoDbjyHuDJ", "true", "<value>", "<value>");
...
**Promise\<[operations.GetDeploymentResponse](../../models/operations/getdeploymentresponse.md)\>**
### Errors
...
async function run() {
  const result = await sdk.deployments.cancel("dpl_5WJWYSyB7BpgTj3EuwF37WMRBXBtPQ2iTMJHJBJyRfd", "<value>", "<value>");
...
**Promise\<[operations.CancelDeploymentResponse](../../models/operations/canceldeploymentresponse.md)\>**
### Errors
...
async function run() {
  const result = await sdk.deployments.uploadFile({});
...
async function run() {
  const result = await sdk.deployments.listDeploymentFiles("<value>", "<value>", "<value>");
...
**Promise\<[operations.ListDeploymentFilesResponse](../../models/operations/listdeploymentfilesresponse.md)\>**
### Errors
...
async function run() {
  const result = await sdk.deployments.getDeploymentFileContents({
    id: "<id>",
    fileId: "<value>",
  });
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetDeploymentFileContentsRequest](../../models/operations/getdeploymentfilecontentsrequest.md)                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
...
**Promise\<[operations.GetDeploymentFileContentsResponse](../../models/operations/getdeploymentfilecontentsresponse.md)\>**
### Errors
...
```typescript
import { SDK } from "@vercel/deployments";
import { QueryParamTarget } from "@vercel/deployments/models/operations";
...
async function run() {
  const result = await sdk.deployments.delete("dpl_5WJWYSyB7BpgTj3EuwF37WMRBXBtPQ2iTMJHJBJyRfd", "https://files-orcin-xi.vercel.app/", "<value>", "<value>");
