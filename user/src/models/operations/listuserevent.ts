...
export type ListUserEventResponse = {
    httpMeta: components.HTTPMetadata;
    /**
     * Successful response.
     */
    object?: ListUserEventResponseBody | undefined;
};
...
/** @internal */
export namespace ListUserEventResponse$ {
    export const inboundSchema: z.ZodType<ListUserEventResponse, z.ZodTypeDef, unknown> = z
        .object({
            HttpMeta: components.HTTPMetadata$.inboundSchema,
            object: z.lazy(() => ListUserEventResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
                httpMeta: v.HttpMeta,
    ...
    export type Outbound = {
        ...
        object?: ListUserEventResponseBody$.Outbound | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListUserEventResponse> = z
        .object({
            httpMeta: components.HTTPMetadata$.outboundSchema,
            object: z.lazy(() => ListUserEventResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                HttpMeta: v.httpMeta,
