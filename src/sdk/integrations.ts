...
export class Integrations extends ClientSDK {
    ...
    async list(
        ...
        const [result$] = await this.matcher<models.GetConfigurationsResponseBody>()
            .json(200, models.GetConfigurationsResponseBody$inboundSchema)
    ...
    async get(
        ...
        const [result$] = await this.matcher<models.GetConfigurationResponseBody>()
            .json(200, models.GetConfigurationResponseBody$inboundSchema)
     ...
     */
    async listGitRepos(
        request?: models.ListGitReposRequest | undefined,
        options?: RequestOptions
        ...
        const [result$] = await this.matcher<models.ListGitReposResponseBody>()
            .json(200, models.ListGitReposResponseBody$inboundSchema)
            .fail([400, 403, "4XX", "5XX"])
            .match(response);
