...
export class AccessGroups extends ClientSDK {
    ...
    async read(
        ...
        return unwrapAsync(accessGroupsRead(this, idOrName, teamId, slug, options));
    }
    ...
    async update(
        ...
        return unwrapAsync(accessGroupsUpdate(this, idOrName, teamId, slug, requestBody, options));
    }
    ...
    async delete(
        ...
        return unwrapAsync(accessGroupsDelete(this, idOrName, teamId, slug, options));
    }
    ...
    async listMembers(
        ...
        return unwrapAsync(accessGroupsListMembers(this, request, options));
    }
     ...
     */
    async list(
        request?: ListAccessGroupsRequest | undefined,
        options?: RequestOptions
    ): Promise<ListAccessGroupsResponseBody> {
        return unwrapAsync(accessGroupsList(this, request, options));
    }
    ...
    async create(
        ...
        return unwrapAsync(accessGroupsCreate(this, teamId, slug, requestBody, options));
    }
    ...
    async listProjects(
        ...
        return unwrapAsync(accessGroupsListProjects(this, request, options));
    }
}
