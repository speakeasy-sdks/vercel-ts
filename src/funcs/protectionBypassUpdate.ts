 ...
 */
export async function protectionBypassUpdate(
    client$: VercelCore,
    idOrName: string,
    ...
    >
> {
    const input$: UpdateProjectProtectionBypassRequest = {
        idOrName: idOrName,
        teamId: teamId,
        slug: slug,
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => UpdateProjectProtectionBypassRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/v1/projects/{idOrName}/protection-bypass")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, UpdateProjectProtectionBypassResponseBody$inboundSchema),
