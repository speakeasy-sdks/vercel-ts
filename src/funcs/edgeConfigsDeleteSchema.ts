...
import {
    ...
    DeleteEdgeConfigSchemaRequest$outboundSchema,
} from "../models/deleteedgeconfigschemaop.js";
import {
    ConnectionError,
    InvalidRequestError,
    RequestAbortedError,
 ...
 */
export async function edgeConfigsDeleteSchema(
    client$: VercelCore,
    edgeConfigId: string,
    ...
    >
> {
    const input$: DeleteEdgeConfigSchemaRequest = {
