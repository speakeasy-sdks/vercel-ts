...
import {
    ...
    GetProjectEnvRequest$outboundSchema,
    GetProjectEnvResponseBody,
    GetProjectEnvResponseBody$inboundSchema,
 ...
 */
export async function projectsGetEnv(
    client$: VercelCore,
    idOrName: string,
    id: string,
    ...
    >
> {
    const input$: GetProjectEnvRequest = {
        idOrName: idOrName,
        id: id,
        teamId: teamId,
        slug: slug,
    ...
    const path$ = pathToFunc("/v1/projects/{idOrName}/env/{id}")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, GetProjectEnvResponseBody$inboundSchema),
