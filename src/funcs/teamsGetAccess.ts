...
import {
    ...
    GetTeamAccessRequestRequest$outboundSchema,
 ...
 */
export async function teamsGetAccess(
    client$: VercelCore,
    teamId: string,
    userId: string,
    ...
    >
> {
    const input$: GetTeamAccessRequestRequest = {
        teamId: teamId,
        userId: userId,
    };
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => GetTeamAccessRequestRequest$outboundSchema.parse(value$),
