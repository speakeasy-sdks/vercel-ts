...
} from "../models/getedgeconfigtokensop.js";
import {
    ConnectionError,
    InvalidRequestError,
    RequestAbortedError,
 ...
 */
export async function edgeConfigListTokens(
    client$: VercelCore,
    edgeConfigId: string,
    ...
    >
> {
    const input$: GetEdgeConfigTokensRequest = {
    ...
    const path$ = pathToFunc("/v1/edge-config/{edgeConfigId}/tokens")(pathParams$);
