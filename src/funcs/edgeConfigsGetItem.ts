...
import { EdgeConfigItem, EdgeConfigItem$inboundSchema } from "../models/edgeconfigitem.js";
import {
 ...
 */
export async function edgeConfigsGetItem(
    client$: VercelCore,
    edgeConfigId: string,
    ...
    >
> {
    const input$: GetEdgeConfigItemRequest = {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => GetEdgeConfigItemRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/v1/edge-config/{edgeConfigId}/item/{edgeConfigItemKey}")(
        pathParams$
    );
