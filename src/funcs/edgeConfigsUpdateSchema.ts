...
import {
    ...
    PatchEdgeConfigSchemaRequest$outboundSchema,
    PatchEdgeConfigSchemaResponseBody,
    PatchEdgeConfigSchemaResponseBody$inboundSchema,
 ...
 */
export async function edgeConfigsUpdateSchema(
    client$: VercelCore,
...
> {
    ...
    const path$ = pathToFunc("/v1/edge-config/{edgeConfigId}/schema")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, PatchEdgeConfigSchemaResponseBody$inboundSchema),
