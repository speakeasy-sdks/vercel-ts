...
import { EdgeConfigToken, EdgeConfigToken$inboundSchema } from "../models/edgeconfigtoken.js";
import {
 ...
 */
export async function edgeConfigGetTokenMetaData(
    client$: VercelCore,
    edgeConfigId: string,
    token: string,
    ...
    >
> {
    const input$: GetEdgeConfigTokenRequest = {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => GetEdgeConfigTokenRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/v1/edge-config/{edgeConfigId}/token/{token}")(pathParams$);
