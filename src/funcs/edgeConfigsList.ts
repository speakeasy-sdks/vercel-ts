...
import {
    ...
    GetEdgeConfigsRequest$outboundSchema,
    GetEdgeConfigsResponseBody,
    GetEdgeConfigsResponseBody$inboundSchema,
 ...
 */
export async function edgeConfigsList(
    client$: VercelCore,
    ...
    >
> {
    const input$: GetEdgeConfigsRequest = {
        teamId: teamId,
        slug: slug,
    };
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => GetEdgeConfigsRequest$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, GetEdgeConfigsResponseBody$inboundSchema),
