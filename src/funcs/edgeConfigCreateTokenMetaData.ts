...
import {
    ...
    CreateEdgeConfigTokenRequest$outboundSchema,
    CreateEdgeConfigTokenRequestBody,
    CreateEdgeConfigTokenResponseBody,
    CreateEdgeConfigTokenResponseBody$inboundSchema,
 ...
 */
export async function edgeConfigCreateTokenMetaData(
    client$: VercelCore,
    edgeConfigId: string,
    ...
    >
> {
    const input$: CreateEdgeConfigTokenRequest = {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => CreateEdgeConfigTokenRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/v1/edge-config/{edgeConfigId}/token")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(201, CreateEdgeConfigTokenResponseBody$inboundSchema),
