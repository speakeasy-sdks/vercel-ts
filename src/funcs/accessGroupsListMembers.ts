 ...
 * List members of an access group
 */
export async function accessGroupsListMembers(
  client$: VercelCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) => ListAccessGroupMembersRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/v1/access-groups/{idOrName}/members")(pathParams$);
