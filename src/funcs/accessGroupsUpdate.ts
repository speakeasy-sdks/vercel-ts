...
import { AccessGroup, AccessGroup$inboundSchema } from "../models/accessgroup.js";
import {
    ConnectionError,
    InvalidRequestError,
    RequestAbortedError,
...
import {
    ...
    UpdateAccessGroupRequest$outboundSchema,
 ...
 */
export async function accessGroupsUpdate(
    client$: VercelCore,
    idOrName: string,
    ...
    >
> {
    const input$: UpdateAccessGroupRequest = {
        idOrName: idOrName,
        teamId: teamId,
        slug: slug,
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, AccessGroup$inboundSchema),
