...
import {
    DeleteTokensRequest,
    DeleteTokensRequest$outboundSchema,
    DeleteTokensRequestBody,
} from "../models/deletetokensop.js";
import {
    ConnectionError,
    InvalidRequestError,
    RequestAbortedError,
 ...
 */
export async function edgeConfigDeleteTokens(
    client$: VercelCore,
    edgeConfigId: string,
    ...
    >
> {
    const input$: DeleteTokensRequest = {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => DeleteTokensRequest$outboundSchema.parse(value$),
