...
import {
    ...
    GetEequestPromoteAliasesRequest$outboundSchema,
    GetEequestPromoteAliasesResponseBody,
    GetEequestPromoteAliasesResponseBody$inboundSchema,
 ...
 */
export async function projectsGetRequestPromoteAliases(
    client$: VercelCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => GetEequestPromoteAliasesRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/v1/projects/{projectId}/promote/aliases")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, GetEequestPromoteAliasesResponseBody$inboundSchema),
