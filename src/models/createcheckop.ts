...
/** @internal */
export const CreateCheckStatus$inboundSchema: z.ZodNativeEnum<typeof CreateCheckStatus> =
    z.nativeEnum(CreateCheckStatus);

/** @internal */
export const CreateCheckStatus$outboundSchema: z.ZodNativeEnum<typeof CreateCheckStatus> =
...
/** @internal */
export const CreateCheckConclusion$inboundSchema: z.ZodNativeEnum<typeof CreateCheckConclusion> =
    z.nativeEnum(CreateCheckConclusion);

/** @internal */
export const CreateCheckConclusion$outboundSchema: z.ZodNativeEnum<typeof CreateCheckConclusion> =
...
/** @internal */
export const CreateCheckSource$inboundSchema: z.ZodNativeEnum<typeof CreateCheckSource> =
    z.nativeEnum(CreateCheckSource);

/** @internal */
export const CreateCheckSource$outboundSchema: z.ZodNativeEnum<typeof CreateCheckSource> =
...
/** @internal */
export const CreateCheckFCP$inboundSchema: z.ZodType<CreateCheckFCP, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export const CreateCheckLCP$inboundSchema: z.ZodType<CreateCheckLCP, z.ZodTypeDef, unknown> =
    z.object({
        value: z.nullable(z.number()),
        previousValue: z.number().optional(),
...
/** @internal */
export const CreateCheckCLS$inboundSchema: z.ZodType<CreateCheckCLS, z.ZodTypeDef, unknown> =
    z.object({
        value: z.nullable(z.number()),
        previousValue: z.number().optional(),
...
export namespace CreateCheckChecksResponse200Source$ {
    ...
    export const outboundSchema = CreateCheckChecksResponse200Source$outboundSchema;
}

/** @internal */
export const CreateCheckTBT$inboundSchema: z.ZodType<CreateCheckTBT, z.ZodTypeDef, unknown> =
    z.object({
        value: z.nullable(z.number()),
        previousValue: z.number().optional(),
...
/** @internal */
export const CreateCheckChecksResponse200ApplicationJSONSource$inboundSchema: z.ZodNativeEnum<
    typeof CreateCheckChecksResponse200ApplicationJSONSource
> = z.nativeEnum(CreateCheckChecksResponse200ApplicationJSONSource);

/** @internal */
export const CreateCheckChecksResponse200ApplicationJSONSource$outboundSchema: z.ZodNativeEnum<
    typeof CreateCheckChecksResponse200ApplicationJSONSource
...
export namespace CreateCheckChecksResponse200ApplicationJSONSource$ {
    ...
    export const inboundSchema = CreateCheckChecksResponse200ApplicationJSONSource$inboundSchema;
    /** @deprecated use `CreateCheckChecksResponse200ApplicationJSONSource$outboundSchema` instead. */
    export const outboundSchema = CreateCheckChecksResponse200ApplicationJSONSource$outboundSchema;
}
...
export namespace CreateCheckVirtualExperienceScore$ {
    ...
    export const outboundSchema = CreateCheckVirtualExperienceScore$outboundSchema;
...
/** @internal */
export const CreateCheckOutput$inboundSchema: z.ZodType<CreateCheckOutput, z.ZodTypeDef, unknown> =
    z.object({
