...
export namespace CreateCheckRequestBody$ {
    export const inboundSchema: z.ZodType<CreateCheckRequestBody, z.ZodTypeDef, unknown> = z.object(
        {
            name: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateCheckRequestBody> =
        z.object({
            name: z.string(),
            path: z.string().optional(),
            blocking: z.boolean(),
...
export namespace CreateCheckStatus$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreateCheckStatus> =
        z.nativeEnum(CreateCheckStatus);
    export const outboundSchema: z.ZodNativeEnum<typeof CreateCheckStatus> = inboundSchema;
}

/** @internal */
export namespace CreateCheckConclusion$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreateCheckConclusion> =
        z.nativeEnum(CreateCheckConclusion);
    export const outboundSchema: z.ZodNativeEnum<typeof CreateCheckConclusion> = inboundSchema;
}

/** @internal */
export namespace CreateCheckSource$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreateCheckSource> =
        z.nativeEnum(CreateCheckSource);
    export const outboundSchema: z.ZodNativeEnum<typeof CreateCheckSource> = inboundSchema;
}

/** @internal */
export namespace CreateCheckFCP$ {
    export const inboundSchema: z.ZodType<CreateCheckFCP, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateCheckFCP> = z.object({
        value: z.nullable(z.number()),
        previousValue: z.number().optional(),
...
export namespace CreateCheckChecksSource$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreateCheckChecksSource> =
        z.nativeEnum(CreateCheckChecksSource);
    export const outboundSchema: z.ZodNativeEnum<typeof CreateCheckChecksSource> = inboundSchema;
}

/** @internal */
export namespace CreateCheckLCP$ {
    export const inboundSchema: z.ZodType<CreateCheckLCP, z.ZodTypeDef, unknown> = z.object({
        value: z.nullable(z.number()),
        previousValue: z.number().optional(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateCheckLCP> = z.object({
        value: z.nullable(z.number()),
        previousValue: z.number().optional(),
...
export namespace CreateCheckChecksResponseSource$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreateCheckChecksResponseSource> =
        z.nativeEnum(CreateCheckChecksResponseSource);
    export const outboundSchema: z.ZodNativeEnum<typeof CreateCheckChecksResponseSource> =
        inboundSchema;
}

/** @internal */
export namespace CreateCheckCLS$ {
    export const inboundSchema: z.ZodType<CreateCheckCLS, z.ZodTypeDef, unknown> = z.object({
        value: z.nullable(z.number()),
        previousValue: z.number().optional(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateCheckCLS> = z.object({
        value: z.nullable(z.number()),
        previousValue: z.number().optional(),
...
export namespace CreateCheckChecksResponse200Source$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreateCheckChecksResponse200Source> =
        z.nativeEnum(CreateCheckChecksResponse200Source);
    export const outboundSchema: z.ZodNativeEnum<typeof CreateCheckChecksResponse200Source> =
        inboundSchema;
}

/** @internal */
export namespace CreateCheckTBT$ {
    export const inboundSchema: z.ZodType<CreateCheckTBT, z.ZodTypeDef, unknown> = z.object({
        value: z.nullable(z.number()),
        previousValue: z.number().optional(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateCheckTBT> = z.object({
        value: z.nullable(z.number()),
        previousValue: z.number().optional(),
...
export namespace CreateCheckOutput$ {
    export const inboundSchema: z.ZodType<CreateCheckOutput, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateCheckOutput> = z.object({
...
export namespace CreateCheckResponseBody$ {
    export const inboundSchema: z.ZodType<CreateCheckResponseBody, z.ZodTypeDef, unknown> =
        z.object({
            id: z.string(),
            name: z.string(),
            path: z.string().optional(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateCheckResponseBody> =
        z.object({
            id: z.string(),
            name: z.string(),
            path: z.string().optional(),
