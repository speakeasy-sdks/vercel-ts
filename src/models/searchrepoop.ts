...
export type SearchRepoIntegrationsProvider = ClosedEnum<typeof SearchRepoIntegrationsProvider>;
...
/** @internal */
export const SearchRepoRequest$inboundSchema: z.ZodType<SearchRepoRequest, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export const SearchRepoProvider$inboundSchema: z.ZodNativeEnum<typeof SearchRepoProvider> =
    z.nativeEnum(SearchRepoProvider);

/** @internal */
export const SearchRepoProvider$outboundSchema: z.ZodNativeEnum<typeof SearchRepoProvider> =
...
/** @internal */
export const SearchRepoId$inboundSchema: z.ZodType<SearchRepoId, z.ZodTypeDef, unknown> = z.union([
    z.string(),
    z.number(),
]);
