...
/** @internal */
export const GetAllChecksConclusion$inboundSchema: z.ZodNativeEnum<typeof GetAllChecksConclusion> =
    z.nativeEnum(GetAllChecksConclusion);

/** @internal */
export const GetAllChecksConclusion$outboundSchema: z.ZodNativeEnum<typeof GetAllChecksConclusion> =
...
/** @internal */
export const GetAllChecksSource$inboundSchema: z.ZodNativeEnum<typeof GetAllChecksSource> =
    z.nativeEnum(GetAllChecksSource);

/** @internal */
export const GetAllChecksSource$outboundSchema: z.ZodNativeEnum<typeof GetAllChecksSource> =
...
/** @internal */
export const GetAllChecksFCP$inboundSchema: z.ZodType<GetAllChecksFCP, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export const GetAllChecksLCP$inboundSchema: z.ZodType<GetAllChecksLCP, z.ZodTypeDef, unknown> =
    z.object({
        value: z.nullable(z.number()),
        previousValue: z.number().optional(),
...
/** @internal */
export const GetAllChecksCLS$inboundSchema: z.ZodType<GetAllChecksCLS, z.ZodTypeDef, unknown> =
    z.object({
        value: z.nullable(z.number()),
        previousValue: z.number().optional(),
...
/** @internal */
export const GetAllChecksChecksResponse200Source$outboundSchema: z.ZodNativeEnum<
    typeof GetAllChecksChecksResponse200Source
...
export namespace GetAllChecksChecksResponse200Source$ {
    ...
    export const inboundSchema = GetAllChecksChecksResponse200Source$inboundSchema;
    /** @deprecated use `GetAllChecksChecksResponse200Source$outboundSchema` instead. */
    export const outboundSchema = GetAllChecksChecksResponse200Source$outboundSchema;
}

/** @internal */
export const GetAllChecksTBT$inboundSchema: z.ZodType<GetAllChecksTBT, z.ZodTypeDef, unknown> =
    z.object({
        value: z.nullable(z.number()),
        previousValue: z.number().optional(),
...
/** @internal */
export const GetAllChecksChecksResponse200ApplicationJSONSource$inboundSchema: z.ZodNativeEnum<
    typeof GetAllChecksChecksResponse200ApplicationJSONSource
> = z.nativeEnum(GetAllChecksChecksResponse200ApplicationJSONSource);

/** @internal */
export const GetAllChecksChecksResponse200ApplicationJSONSource$outboundSchema: z.ZodNativeEnum<
    typeof GetAllChecksChecksResponse200ApplicationJSONSource
...
export namespace GetAllChecksChecksResponse200ApplicationJSONSource$ {
    ...
    export const inboundSchema = GetAllChecksChecksResponse200ApplicationJSONSource$inboundSchema;
    /** @deprecated use `GetAllChecksChecksResponse200ApplicationJSONSource$outboundSchema` instead. */
    export const outboundSchema = GetAllChecksChecksResponse200ApplicationJSONSource$outboundSchema;
}
...
export namespace GetAllChecksVirtualExperienceScore$ {
    ...
    export const outboundSchema = GetAllChecksVirtualExperienceScore$outboundSchema;
...
/** @internal */
export const GetAllChecksStatus$inboundSchema: z.ZodNativeEnum<typeof GetAllChecksStatus> =
    z.nativeEnum(GetAllChecksStatus);

/** @internal */
export const GetAllChecksStatus$outboundSchema: z.ZodNativeEnum<typeof GetAllChecksStatus> =
