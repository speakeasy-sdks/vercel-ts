...
export namespace GetAllChecksConclusion$ {
    export const inboundSchema = z.nativeEnum(GetAllChecksConclusion);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace GetAllChecksSource$ {
    export const inboundSchema = z.nativeEnum(GetAllChecksSource);
    export const outboundSchema = inboundSchema;
}
...
export namespace GetAllChecksChecksSource$ {
    export const inboundSchema = z.nativeEnum(GetAllChecksChecksSource);
    export const outboundSchema = inboundSchema;
}
...
export namespace GetAllChecksChecksResponseSource$ {
    export const inboundSchema = z.nativeEnum(GetAllChecksChecksResponseSource);
    export const outboundSchema = inboundSchema;
}
...
export namespace GetAllChecksChecksResponse200Source$ {
    export const inboundSchema = z.nativeEnum(GetAllChecksChecksResponse200Source);
    export const outboundSchema = inboundSchema;
}
...
export namespace GetAllChecksChecksResponse200ApplicationJSONSource$ {
    export const inboundSchema = z.nativeEnum(GetAllChecksChecksResponse200ApplicationJSONSource);
    export const outboundSchema = inboundSchema;
}
...
export namespace GetAllChecksStatus$ {
    export const inboundSchema = z.nativeEnum(GetAllChecksStatus);
    export const outboundSchema = inboundSchema;
}

/** @internal */
export namespace GetAllChecksChecks$ {
    export const inboundSchema: z.ZodType<GetAllChecksChecks, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetAllChecksChecks> = z
        .object({
            completedAt: z.number().optional(),
