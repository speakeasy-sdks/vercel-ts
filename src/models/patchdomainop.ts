...
export namespace PatchDomainRequestBody2$ {
    export const inboundSchema: z.ZodType<PatchDomainRequestBody2, z.ZodTypeDef, unknown> =
        z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PatchDomainRequestBody2> =
        z.object({
            op: z.string().optional(),
            destination: z.string().optional(),
        });
...
export namespace PatchDomainRequestBody1$ {
    export const inboundSchema: z.ZodType<PatchDomainRequestBody1, z.ZodTypeDef, unknown> =
        z.object({
            op: z.string().optional(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PatchDomainRequestBody1> =
        z.object({
            op: z.string().optional(),
            renew: z.boolean().optional(),
            customNameservers: z.array(z.string()).optional(),
...
export namespace PatchDomainResponseBody3$ {
    export const inboundSchema: z.ZodType<PatchDomainResponseBody3, z.ZodTypeDef, unknown> =
        z.object({
            renew: z.boolean().optional(),
            customNameservers: z.array(z.string()).optional(),
            zone: z.boolean().optional(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PatchDomainResponseBody3> =
        z.object({
            renew: z.boolean().optional(),
            customNameservers: z.array(z.string()).optional(),
            zone: z.boolean().optional(),
...
export namespace PatchDomainResponseBody2$ {
    export const inboundSchema: z.ZodType<PatchDomainResponseBody2, z.ZodTypeDef, unknown> =
        z.object({
            moved: z.boolean(),
            token: z.string(),
        });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PatchDomainResponseBody2> =
        z.object({
            moved: z.boolean(),
            token: z.string(),
        });
...
export namespace PatchDomainResponseBody1$ {
    export const inboundSchema: z.ZodType<PatchDomainResponseBody1, z.ZodTypeDef, unknown> =
        z.object({
            moved: z.boolean(),
        });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PatchDomainResponseBody1> =
        z.object({
            moved: z.boolean(),
        });
}
