...
export namespace GetIntegrationLogDrainsDeliveryFormat$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetIntegrationLogDrainsDeliveryFormat> =
        z.nativeEnum(GetIntegrationLogDrainsDeliveryFormat);
    export const outboundSchema: z.ZodNativeEnum<typeof GetIntegrationLogDrainsDeliveryFormat> =
        inboundSchema;
}

/** @internal */
export namespace GetIntegrationLogDrainsSources$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetIntegrationLogDrainsSources> =
        z.nativeEnum(GetIntegrationLogDrainsSources);
    export const outboundSchema: z.ZodNativeEnum<typeof GetIntegrationLogDrainsSources> =
        inboundSchema;
}

/** @internal */
export namespace CreatedFrom$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreatedFrom> = z.nativeEnum(CreatedFrom);
    export const outboundSchema: z.ZodNativeEnum<typeof CreatedFrom> = inboundSchema;
}

/** @internal */
export namespace GetIntegrationLogDrainsEnvironments$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetIntegrationLogDrainsEnvironments> =
        z.nativeEnum(GetIntegrationLogDrainsEnvironments);
    export const outboundSchema: z.ZodNativeEnum<typeof GetIntegrationLogDrainsEnvironments> =
        inboundSchema;
}
