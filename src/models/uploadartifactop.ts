...
export namespace UploadArtifactResponseBody$ {
    export const inboundSchema: z.ZodType<UploadArtifactResponseBody, z.ZodTypeDef, unknown> =
        z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UploadArtifactResponseBody> =
        z.object({
            urls: z.array(z.string()),
        });
}
