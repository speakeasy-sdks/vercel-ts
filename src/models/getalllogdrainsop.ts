...
export namespace GetAllLogDrainsDeliveryFormat$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsDeliveryFormat> =
        z.nativeEnum(GetAllLogDrainsDeliveryFormat);
    export const outboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsDeliveryFormat> =
        inboundSchema;
}

/** @internal */
export namespace GetAllLogDrainsSources$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsSources> =
        z.nativeEnum(GetAllLogDrainsSources);
    export const outboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsSources> = inboundSchema;
}

/** @internal */
export namespace GetAllLogDrainsEnvironments$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsEnvironments> = z.nativeEnum(
        GetAllLogDrainsEnvironments
    );
    export const outboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsEnvironments> =
        inboundSchema;
}

/** @internal */
export namespace GetAllLogDrainsStatus$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsStatus> =
        z.nativeEnum(GetAllLogDrainsStatus);
    export const outboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsStatus> = inboundSchema;
}

/** @internal */
export namespace GetAllLogDrainsDisabledReason$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsDisabledReason> =
        z.nativeEnum(GetAllLogDrainsDisabledReason);
    export const outboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsDisabledReason> =
        inboundSchema;
}

/** @internal */
export namespace GetAllLogDrainsCompression$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsCompression> = z.nativeEnum(
        GetAllLogDrainsCompression
    );
    export const outboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsCompression> = inboundSchema;
}

/** @internal */
export namespace GetAllLogDrainsCreatedFrom$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsCreatedFrom> = z.nativeEnum(
        GetAllLogDrainsCreatedFrom
    );
    export const outboundSchema: z.ZodNativeEnum<typeof GetAllLogDrainsCreatedFrom> = inboundSchema;
}
