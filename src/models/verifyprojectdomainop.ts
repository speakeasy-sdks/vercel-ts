...
> = z.object({
    ...
    verified: z.boolean(),
    verification: z.array(z.lazy(() => VerifyProjectDomainVerification$inboundSchema)).optional(),
});
...
> = z.object({
    ...
    createdAt: z.number().optional(),
    verified: z.boolean(),
    verification: z.array(z.lazy(() => VerifyProjectDomainVerification$outboundSchema)).optional(),
});
