...
export namespace ServiceType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof ServiceType> = z.nativeEnum(ServiceType);
    export const outboundSchema: z.ZodNativeEnum<typeof ServiceType> = inboundSchema;
}
