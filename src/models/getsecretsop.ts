...
/** @internal */
export const GetSecretsRequest$inboundSchema: z.ZodType<GetSecretsRequest, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export const GetSecretsSecrets$inboundSchema: z.ZodType<GetSecretsSecrets, z.ZodTypeDef, unknown> =
    z.object({
        created: z
            .string()
