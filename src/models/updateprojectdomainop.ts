...
export namespace RedirectStatusCode$ {
    export const inboundSchema: z.ZodNativeEnum<typeof RedirectStatusCode> =
        z.nativeEnum(RedirectStatusCode);
    export const outboundSchema: z.ZodNativeEnum<typeof RedirectStatusCode> = inboundSchema;
}

/** @internal */
export namespace UpdateProjectDomainRequestBody$ {
    export const inboundSchema: z.ZodType<UpdateProjectDomainRequestBody, z.ZodTypeDef, unknown> =
        z.object({
