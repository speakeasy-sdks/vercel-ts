...
export namespace CreateSecretRequestBody$ {
    export const inboundSchema: z.ZodType<CreateSecretRequestBody, z.ZodTypeDef, unknown> =
        z.object({
            name: z.string(),
            value: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateSecretRequestBody> =
        z.object({
            name: z.string(),
            value: z.string(),
            decryptable: z.boolean().optional(),
...
export namespace CreateSecretType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreateSecretType> =
        z.nativeEnum(CreateSecretType);
    export const outboundSchema: z.ZodNativeEnum<typeof CreateSecretType> = inboundSchema;
}
...
export namespace CreateSecretResponseBody$ {
    export const inboundSchema: z.ZodType<CreateSecretResponseBody, z.ZodTypeDef, unknown> =
        z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateSecretResponseBody> =
        z.object({
