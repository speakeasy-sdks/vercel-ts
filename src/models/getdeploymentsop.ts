...
export namespace QueryParamTarget$ {
    export const inboundSchema: z.ZodNativeEnum<typeof QueryParamTarget> =
        z.nativeEnum(QueryParamTarget);
    export const outboundSchema: z.ZodNativeEnum<typeof QueryParamTarget> = inboundSchema;
}
...
export namespace GetDeploymentsSource$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetDeploymentsSource> =
        z.nativeEnum(GetDeploymentsSource);
    export const outboundSchema: z.ZodNativeEnum<typeof GetDeploymentsSource> = inboundSchema;
}

/** @internal */
export namespace GetDeploymentsState$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetDeploymentsState> =
        z.nativeEnum(GetDeploymentsState);
    export const outboundSchema: z.ZodNativeEnum<typeof GetDeploymentsState> = inboundSchema;
}

/** @internal */
export namespace GetDeploymentsReadyState$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetDeploymentsReadyState> =
        z.nativeEnum(GetDeploymentsReadyState);
    export const outboundSchema: z.ZodNativeEnum<typeof GetDeploymentsReadyState> = inboundSchema;
}

/** @internal */
export namespace GetDeploymentsType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetDeploymentsType> =
        z.nativeEnum(GetDeploymentsType);
    export const outboundSchema: z.ZodNativeEnum<typeof GetDeploymentsType> = inboundSchema;
}
...
export namespace GetDeploymentsTarget$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetDeploymentsTarget> =
        z.nativeEnum(GetDeploymentsTarget);
    export const outboundSchema: z.ZodNativeEnum<typeof GetDeploymentsTarget> = inboundSchema;
}
...
export namespace GetDeploymentsReadySubstate$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetDeploymentsReadySubstate> = z.nativeEnum(
        GetDeploymentsReadySubstate
    );
    export const outboundSchema: z.ZodNativeEnum<typeof GetDeploymentsReadySubstate> =
        inboundSchema;
}

/** @internal */
export namespace GetDeploymentsChecksState$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetDeploymentsChecksState> =
        z.nativeEnum(GetDeploymentsChecksState);
    export const outboundSchema: z.ZodNativeEnum<typeof GetDeploymentsChecksState> = inboundSchema;
}

/** @internal */
export namespace GetDeploymentsChecksConclusion$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetDeploymentsChecksConclusion> =
        z.nativeEnum(GetDeploymentsChecksConclusion);
    export const outboundSchema: z.ZodNativeEnum<typeof GetDeploymentsChecksConclusion> =
        inboundSchema;
}

/** @internal */
export namespace GetDeploymentsFramework$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetDeploymentsFramework> =
        z.nativeEnum(GetDeploymentsFramework);
    export const outboundSchema: z.ZodNativeEnum<typeof GetDeploymentsFramework> = inboundSchema;
}

/** @internal */
export namespace GetDeploymentsNodeVersion$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetDeploymentsNodeVersion> =
        z.nativeEnum(GetDeploymentsNodeVersion);
    export const outboundSchema: z.ZodNativeEnum<typeof GetDeploymentsNodeVersion> = inboundSchema;
}
