...
export namespace RecordEventsResponse$ {
    export const inboundSchema: z.ZodType<RecordEventsResponse, z.ZodTypeDef, unknown> = z.object(
        {}
    );

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, RecordEventsResponse> = z.object(
        {}
    );
}
