...
export const UpdateProjectDataCacheContentHintProjectsResponse200ApplicationJSONResponseBodyEnv1Type =
    {
        RedisUrl: "redis-url",
    } as const;
export type UpdateProjectDataCacheContentHintProjectsResponse200ApplicationJSONResponseBodyEnv1Type =
    ClosedEnum<
