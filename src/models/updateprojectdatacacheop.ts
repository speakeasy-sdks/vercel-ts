...
export namespace UpdateProjectDataCacheSecurity$ {
    export const inboundSchema: z.ZodType<UpdateProjectDataCacheSecurity, z.ZodTypeDef, unknown> = z
        .object({
            ...
            .transform((v) => {
                return {
                    ...
                    ...(v.firewallConfigVersion === undefined
                        ? null
                        : { firewallConfigVersion: v.firewallConfigVersion }),
                    ...(v.firewallRoutes === undefined
                        ? null
                        : { firewallRoutes: v.firewallRoutes }),
                    ...(v.firewallSeawallEnabled === undefined
                        ? null
                        : { firewallSeawallEnabled: v.firewallSeawallEnabled }),
                    ...(v.ja3Enabled === undefined ? null : { ja3Enabled: v.ja3Enabled }),
...
export namespace UpdateProjectDataCacheResponseBody$ {
    ...
    > = z
        .object({
            ...
            webAnalytics: z
                .lazy(() => UpdateProjectDataCacheWebAnalytics$.inboundSchema)
                .optional(),
    ...
    > = z
        .object({
            ...
            concurrencyBucketName: z.string().optional(),
            webAnalytics: z
                .lazy(() => UpdateProjectDataCacheWebAnalytics$.outboundSchema)
                .optional(),
