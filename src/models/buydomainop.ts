...
/** @internal */
export const BuyDomainRequest$inboundSchema: z.ZodType<BuyDomainRequest, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const BuyDomainDomain$inboundSchema: z.ZodType<BuyDomainDomain, z.ZodTypeDef, unknown> =
    z.object({
        uid: z.string(),
        ns: z.array(z.string()),
        verified: z.boolean(),
...
/** @internal */
export const BuyDomainResponse$inboundSchema: z.ZodType<BuyDomainResponse, z.ZodTypeDef, unknown> =
    z.union([
