...
export namespace BuyDomainRequestBody$ {
    export const inboundSchema: z.ZodType<BuyDomainRequestBody, z.ZodTypeDef, unknown> = z.object({
        name: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BuyDomainRequestBody> = z.object(
        {
            name: z.string(),
            expectedPrice: z.number().optional(),
            renew: z.boolean().optional(),
...
export namespace BuyDomainDomain$ {
    export const inboundSchema: z.ZodType<BuyDomainDomain, z.ZodTypeDef, unknown> = z.object({
        uid: z.string(),
        ns: z.array(z.string()),
        verified: z.boolean(),
        created: z.number(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BuyDomainDomain> = z.object({
        uid: z.string(),
        ns: z.array(z.string()),
        verified: z.boolean(),
        created: z.number(),
...
export namespace BuyDomainDomainsResponseBody$ {
    export const inboundSchema: z.ZodType<BuyDomainDomainsResponseBody, z.ZodTypeDef, unknown> =
        z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BuyDomainDomainsResponseBody> =
        z.object({
...
export namespace BuyDomainDomainsDomain$ {
    export const inboundSchema: z.ZodType<BuyDomainDomainsDomain, z.ZodTypeDef, unknown> = z.object(
        {
            uid: z.string(),
            ns: z.array(z.string()),
            verified: z.boolean(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BuyDomainDomainsDomain> =
        z.object({
            uid: z.string(),
            ns: z.array(z.string()),
            verified: z.boolean(),
...
export namespace BuyDomainResponseBody$ {
    export const inboundSchema: z.ZodType<BuyDomainResponseBody, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BuyDomainResponseBody> =
        z.object({
