...
export type RemoveTeamMemberResponse = {
     ...
     * Successfully removed a member of the team.
     */
    object?: RemoveTeamMemberResponseBody | undefined;
};
...
/** @internal */
export namespace RemoveTeamMemberResponse$ {
    export const inboundSchema: z.ZodType<RemoveTeamMemberResponse, z.ZodTypeDef, unknown> = z
        .object({
            HttpMeta: HTTPMetadata$.inboundSchema,
            object: z.lazy(() => RemoveTeamMemberResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
                httpMeta: v.HttpMeta,
    ...
    export type Outbound = {
        ...
        object?: RemoveTeamMemberResponseBody$.Outbound | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, RemoveTeamMemberResponse> = z
        .object({
            httpMeta: HTTPMetadata$.outboundSchema,
            object: z.lazy(() => RemoveTeamMemberResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                HttpMeta: v.httpMeta,
