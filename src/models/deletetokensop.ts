...
export namespace DeleteTokensResponse$ {
    export const inboundSchema: z.ZodType<DeleteTokensResponse, z.ZodTypeDef, unknown> = z.object(
        {}
    );

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, DeleteTokensResponse> = z.object(
        {}
    );
}
