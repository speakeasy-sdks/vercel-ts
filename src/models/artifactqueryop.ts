...
export type ArtifactQueryResponse = {
    ...
    object?: Record<string, ArtifactQueryResponseBody2 | ArtifactQueryResponseBody1> | undefined;
};
...
export namespace ArtifactQueryResponseBody2$ {
    export const inboundSchema: z.ZodType<ArtifactQueryResponseBody2, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ArtifactQueryResponseBody2> = z
        .object({
...
export namespace ArtifactQueryResponseBody1$ {
    export const inboundSchema: z.ZodType<ArtifactQueryResponseBody1, z.ZodTypeDef, unknown> = z
        .object({
            size: z.number(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ArtifactQueryResponseBody1> = z
        .object({
            size: z.number(),
            taskDurationMs: z.number(),
            tag: z.string().optional(),
...
/** @internal */
export namespace ArtifactQueryResponse$ {
    export const inboundSchema: z.ZodType<ArtifactQueryResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export type Outbound = {
        ...
        object?:
            | Record<
                  string,
                  ArtifactQueryResponseBody2$.Outbound | ArtifactQueryResponseBody1$.Outbound
              >
            | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ArtifactQueryResponse> = z
        .object({
