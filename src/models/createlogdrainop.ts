...
export namespace DeliveryFormat$ {
    export const inboundSchema: z.ZodNativeEnum<typeof DeliveryFormat> =
        z.nativeEnum(DeliveryFormat);
    export const outboundSchema: z.ZodNativeEnum<typeof DeliveryFormat> = inboundSchema;
}

/** @internal */
export namespace Sources$ {
    export const inboundSchema: z.ZodNativeEnum<typeof Sources> = z.nativeEnum(Sources);
    export const outboundSchema: z.ZodNativeEnum<typeof Sources> = inboundSchema;
}

/** @internal */
export namespace Environments$ {
    export const inboundSchema: z.ZodNativeEnum<typeof Environments> = z.nativeEnum(Environments);
    export const outboundSchema: z.ZodNativeEnum<typeof Environments> = inboundSchema;
}
...
export namespace CreateLogDrainDeliveryFormat$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreateLogDrainDeliveryFormat> = z.nativeEnum(
        CreateLogDrainDeliveryFormat
    );
    export const outboundSchema: z.ZodNativeEnum<typeof CreateLogDrainDeliveryFormat> =
        inboundSchema;
}

/** @internal */
export namespace CreateLogDrainSources$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreateLogDrainSources> =
        z.nativeEnum(CreateLogDrainSources);
    export const outboundSchema: z.ZodNativeEnum<typeof CreateLogDrainSources> = inboundSchema;
}

/** @internal */
export namespace CreateLogDrainCreatedFrom$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreateLogDrainCreatedFrom> =
        z.nativeEnum(CreateLogDrainCreatedFrom);
    export const outboundSchema: z.ZodNativeEnum<typeof CreateLogDrainCreatedFrom> = inboundSchema;
}

/** @internal */
export namespace CreateLogDrainEnvironments$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreateLogDrainEnvironments> = z.nativeEnum(
        CreateLogDrainEnvironments
    );
    export const outboundSchema: z.ZodNativeEnum<typeof CreateLogDrainEnvironments> = inboundSchema;
}
