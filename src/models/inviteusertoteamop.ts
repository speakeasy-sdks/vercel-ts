...
> = z.object({
    ...
    role: InviteUserToTeamTeamsRole$inboundSchema.default(InviteUserToTeamTeamsRole.Member),
...
> = z.object({
    uid: z.string().optional(),
    email: z.string().optional(),
    role: InviteUserToTeamTeamsRole$outboundSchema.default(InviteUserToTeamTeamsRole.Member),
