...
export namespace InviteUserToTeamTeamsRole$ {
    export const inboundSchema: z.ZodNativeEnum<typeof InviteUserToTeamTeamsRole> =
        z.nativeEnum(InviteUserToTeamTeamsRole);
    export const outboundSchema: z.ZodNativeEnum<typeof InviteUserToTeamTeamsRole> = inboundSchema;
}

/** @internal */
export namespace InviteUserToTeamRole$ {
    export const inboundSchema: z.ZodNativeEnum<typeof InviteUserToTeamRole> =
        z.nativeEnum(InviteUserToTeamRole);
    export const outboundSchema: z.ZodNativeEnum<typeof InviteUserToTeamRole> = inboundSchema;
}
...
export namespace InviteUserToTeamResponseBodyRole$ {
    export const inboundSchema: z.ZodNativeEnum<typeof InviteUserToTeamResponseBodyRole> =
        z.nativeEnum(InviteUserToTeamResponseBodyRole);
    export const outboundSchema: z.ZodNativeEnum<typeof InviteUserToTeamResponseBodyRole> =
        inboundSchema;
}
...
export namespace ResponseBodyRole$ {
    export const inboundSchema: z.ZodNativeEnum<typeof ResponseBodyRole> =
        z.nativeEnum(ResponseBodyRole);
    export const outboundSchema: z.ZodNativeEnum<typeof ResponseBodyRole> = inboundSchema;
}
