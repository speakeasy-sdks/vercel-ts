...
export namespace CreateOrTransferDomainCreator$ {
    export const inboundSchema: z.ZodType<CreateOrTransferDomainCreator, z.ZodTypeDef, unknown> =
        z.object({
            username: z.string(),
            email: z.string(),
...
export namespace CreateOrTransferDomainServiceType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreateOrTransferDomainServiceType> =
        z.nativeEnum(CreateOrTransferDomainServiceType);
    export const outboundSchema: z.ZodNativeEnum<typeof CreateOrTransferDomainServiceType> =
        inboundSchema;
}

/** @internal */
export namespace CreateOrTransferDomainDomain$ {
    export const inboundSchema: z.ZodType<CreateOrTransferDomainDomain, z.ZodTypeDef, unknown> =
        z.object({
            verified: z.boolean(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateOrTransferDomainDomain> =
        z.object({
            verified: z.boolean(),
            nameservers: z.array(z.string()),
            intendedNameservers: z.array(z.string()),
