...
export namespace QueryParamProvider$ {
    export const inboundSchema = z.nativeEnum(QueryParamProvider);
...
export namespace ListGitReposProvider$ {
    export const inboundSchema = z.nativeEnum(ListGitReposProvider);
    export const outboundSchema = inboundSchema;
}
...
export namespace ListGitReposIntegrationsProvider$ {
    export const inboundSchema = z.nativeEnum(ListGitReposIntegrationsProvider);
    export const outboundSchema = inboundSchema;
}
