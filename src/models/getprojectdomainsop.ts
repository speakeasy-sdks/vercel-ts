...
/** @internal */
export const Production$inboundSchema: z.ZodNativeEnum<typeof Production> =
    z.nativeEnum(Production);
...
/** @internal */
export const Redirects$inboundSchema: z.ZodNativeEnum<typeof Redirects> = z.nativeEnum(Redirects);

/** @internal */
export const Redirects$outboundSchema: z.ZodNativeEnum<typeof Redirects> = Redirects$inboundSchema;
...
/** @internal */
export const Verified$inboundSchema: z.ZodNativeEnum<typeof Verified> = z.nativeEnum(Verified);

/** @internal */
export const Verified$outboundSchema: z.ZodNativeEnum<typeof Verified> = Verified$inboundSchema;
