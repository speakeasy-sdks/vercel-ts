...
export namespace GetDomainsRequest$ {
    export const inboundSchema: z.ZodType<GetDomainsRequest, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetDomainsRequest> = z.object({
        limit: z.number().optional(),
        since: z.number().optional(),
        until: z.number().optional(),
        teamId: z.string().optional(),
...
export namespace GetDomainsCreator$ {
    export const inboundSchema: z.ZodType<GetDomainsCreator, z.ZodTypeDef, unknown> = z.object({
        username: z.string(),
        email: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetDomainsCreator> = z.object({
        username: z.string(),
        email: z.string(),
        customerId: z.nullable(z.string()).optional(),
        isDomainReseller: z.boolean().optional(),
...
export namespace GetDomainsServiceType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetDomainsServiceType> =
        z.nativeEnum(GetDomainsServiceType);
    export const outboundSchema: z.ZodNativeEnum<typeof GetDomainsServiceType> = inboundSchema;
}

/** @internal */
export namespace GetDomainsDomains$ {
    export const inboundSchema: z.ZodType<GetDomainsDomains, z.ZodTypeDef, unknown> = z.object({
        verified: z.boolean(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetDomainsDomains> = z.object({
        verified: z.boolean(),
        nameservers: z.array(z.string()),
        intendedNameservers: z.array(z.string()),
        customNameservers: z.array(z.string()).optional(),
...
export namespace GetDomainsResponseBody$ {
    export const inboundSchema: z.ZodType<GetDomainsResponseBody, z.ZodTypeDef, unknown> = z.object(
        {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetDomainsResponseBody> =
        z.object({
