...
/** @internal */
export const RequestBodyRole$inboundSchema: z.ZodNativeEnum<typeof RequestBodyRole> =
    z.nativeEnum(RequestBodyRole);

/** @internal */
export const RequestBodyRole$outboundSchema: z.ZodNativeEnum<typeof RequestBodyRole> =
