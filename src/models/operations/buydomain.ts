...
export type BuyDomainResponse = {
     ...
     * Successful response for purchasing a Domain.
     */
    twoHundredAndOneApplicationJsonObject?: BuyDomainResponseBody | undefined;
    /**
     * Domain purchase is being processed asynchronously.
     */
    twoHundredAndTwoApplicationJsonObject?: BuyDomainDomainsResponseBody | undefined;
};
...
export namespace BuyDomainResponse$ {
    export const inboundSchema: z.ZodType<BuyDomainResponse, z.ZodTypeDef, unknown> = z
        .object({
            HttpMeta: components.HTTPMetadata$.inboundSchema,
            "201_application/json_object": z
                .lazy(() => BuyDomainResponseBody$.inboundSchema)
                .optional(),
            "202_application/json_object": z
                .lazy(() => BuyDomainDomainsResponseBody$.inboundSchema)
                .optional(),
        })
        .transform((v) => {
            return {
                ...
                ...(v["202_application/json_object"] === undefined
                    ? null
                    : { twoHundredAndTwoApplicationJsonObject: v["202_application/json_object"] }),
            };
        });

    export type Outbound = {
        HttpMeta: components.HTTPMetadata$.Outbound;
        "201_application/json_object"?: BuyDomainResponseBody$.Outbound | undefined;
        "202_application/json_object"?: BuyDomainDomainsResponseBody$.Outbound | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BuyDomainResponse> = z
        .object({
            httpMeta: components.HTTPMetadata$.outboundSchema,
            twoHundredAndOneApplicationJsonObject: z
                .lazy(() => BuyDomainResponseBody$.outboundSchema)
                .optional(),
            twoHundredAndTwoApplicationJsonObject: z
                .lazy(() => BuyDomainDomainsResponseBody$.outboundSchema)
                .optional(),
        })
        .transform((v) => {
            return {
                ...
                ...(v.twoHundredAndTwoApplicationJsonObject === undefined
                    ? null
                    : { "202_application/json_object": v.twoHundredAndTwoApplicationJsonObject }),
            };
        });
}
