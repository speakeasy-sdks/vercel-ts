...
export type VerifyProjectDomainResponse = {
     ...
     * Domain is already verified
     */
    object?: VerifyProjectDomainResponseBody | undefined;
};
...
/** @internal */
export namespace VerifyProjectDomainResponse$ {
    export const inboundSchema: z.ZodType<VerifyProjectDomainResponse, z.ZodTypeDef, unknown> = z
        .object({
            HttpMeta: components.HTTPMetadata$.inboundSchema,
            object: z.lazy(() => VerifyProjectDomainResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
                httpMeta: v.HttpMeta,
    ...
    export type Outbound = {
        ...
        object?: VerifyProjectDomainResponseBody$.Outbound | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, VerifyProjectDomainResponse> = z
        .object({
            httpMeta: components.HTTPMetadata$.outboundSchema,
            object: z.lazy(() => VerifyProjectDomainResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                HttpMeta: v.httpMeta,
