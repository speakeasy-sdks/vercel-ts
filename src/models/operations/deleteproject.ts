...
export namespace DeleteProjectResponse$ {
    export const inboundSchema: z.ZodType<DeleteProjectResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, DeleteProjectResponse> = z
        .object({
