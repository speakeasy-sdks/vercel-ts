...
/** @internal */
export const QueryParamTarget$: z.ZodNativeEnum<typeof QueryParamTarget> =
...
export namespace GetDeploymentsRequest$ {
    export const inboundSchema: z.ZodType<GetDeploymentsRequest, z.ZodTypeDef, unknown> = z
        .object({
            ...
            target: QueryParamTarget$.optional(),
...
/** @internal */
export const GetDeploymentsSource$: z.ZodNativeEnum<typeof GetDeploymentsSource> =
    z.nativeEnum(GetDeploymentsSource);

/** @internal */
export const GetDeploymentsState$: z.ZodNativeEnum<typeof GetDeploymentsState> =
    z.nativeEnum(GetDeploymentsState);

/** @internal */
export const GetDeploymentsReadyState$: z.ZodNativeEnum<typeof GetDeploymentsReadyState> =
    z.nativeEnum(GetDeploymentsReadyState);

/** @internal */
export const GetDeploymentsType$: z.ZodNativeEnum<typeof GetDeploymentsType> =
...
/** @internal */
export const GetDeploymentsTarget$: z.ZodNativeEnum<typeof GetDeploymentsTarget> =
...
/** @internal */
export const GetDeploymentsReadySubstate$: z.ZodNativeEnum<typeof GetDeploymentsReadySubstate> =
    z.nativeEnum(GetDeploymentsReadySubstate);

/** @internal */
export const GetDeploymentsChecksState$: z.ZodNativeEnum<typeof GetDeploymentsChecksState> =
    z.nativeEnum(GetDeploymentsChecksState);

/** @internal */
export const GetDeploymentsChecksConclusion$: z.ZodNativeEnum<
    typeof GetDeploymentsChecksConclusion
> = z.nativeEnum(GetDeploymentsChecksConclusion);

/** @internal */
export const GetDeploymentsFramework$: z.ZodNativeEnum<typeof GetDeploymentsFramework> =
    z.nativeEnum(GetDeploymentsFramework);

/** @internal */
export const GetDeploymentsNodeVersion$: z.ZodNativeEnum<typeof GetDeploymentsNodeVersion> =
...
export namespace GetDeploymentsProjectSettings$ {
    export const inboundSchema: z.ZodType<GetDeploymentsProjectSettings, z.ZodTypeDef, unknown> = z
        .object({
            framework: z.nullable(GetDeploymentsFramework$).optional(),
            ...
            nodeVersion: GetDeploymentsNodeVersion$.optional(),
...
export namespace Deployments$ {
    export const inboundSchema: z.ZodType<Deployments, z.ZodTypeDef, unknown> = z
        .object({
            uid: z.string(),
            name: z.string(),
            url: z.string(),
            created: z.number(),
            source: GetDeploymentsSource$.optional(),
            state: GetDeploymentsState$.optional(),
            readyState: GetDeploymentsReadyState$.optional(),
            type: GetDeploymentsType$,
            creator: z.lazy(() => GetDeploymentsCreator$.inboundSchema),
            meta: z.record(z.string()).optional(),
            target: z.nullable(GetDeploymentsTarget$).optional(),
            aliasError: z
            ...
            readySubstate: GetDeploymentsReadySubstate$.optional(),
            checksState: GetDeploymentsChecksState$.optional(),
            checksConclusion: GetDeploymentsChecksConclusion$.optional(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Deployments> = z
        .object({
            uid: z.string(),
            name: z.string(),
            url: z.string(),
