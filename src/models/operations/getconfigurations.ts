...
/** @internal */
export const View$: z.ZodNativeEnum<typeof View> = z.nativeEnum(View);
...
/** @internal */
export const GetConfigurationsResponseBodyIntegrationsSource$: z.ZodNativeEnum<
    typeof GetConfigurationsResponseBodyIntegrationsSource
> = z.nativeEnum(GetConfigurationsResponseBodyIntegrationsSource);

/** @internal */
export const GetConfigurationsResponseBodyIntegrationsType$: z.ZodNativeEnum<
    typeof GetConfigurationsResponseBodyIntegrationsType
> = z.nativeEnum(GetConfigurationsResponseBodyIntegrationsType);

/** @internal */
export const ResponseBodyAdded$: z.ZodNativeEnum<typeof ResponseBodyAdded> =
    z.nativeEnum(ResponseBodyAdded);

/** @internal */
export const ResponseBodyUpgraded$: z.ZodNativeEnum<typeof ResponseBodyUpgraded> =
...
export namespace ResponseBodyScopes$ {
    export const inboundSchema: z.ZodType<ResponseBodyScopes, z.ZodTypeDef, unknown> = z
        .object({
            added: z.array(ResponseBodyAdded$),
            upgraded: z.array(ResponseBodyUpgraded$),
        })
        .transform((v) => {
            return {
                added: v.added,
...
/** @internal */
export const ResponseBodyDisabledReason$: z.ZodNativeEnum<typeof ResponseBodyDisabledReason> =
    z.nativeEnum(ResponseBodyDisabledReason);

/** @internal */
export const ResponseBodyInstallationType$: z.ZodNativeEnum<typeof ResponseBodyInstallationType> =
...
export namespace GetConfigurationsResponseBody2$ {
    export const inboundSchema: z.ZodType<GetConfigurationsResponseBody2, z.ZodTypeDef, unknown> = z
        .object({
            ...
            source: GetConfigurationsResponseBodyIntegrationsSource$.optional(),
            ...
            disabledReason: ResponseBodyDisabledReason$.optional(),
            northstarMigratedAt: z.number().optional(),
            installationType: ResponseBodyInstallationType$.optional(),
        })
        .transform((v) => {
            return {
...
/** @internal */
export const GetConfigurationsResponseBodySource$: z.ZodNativeEnum<
    typeof GetConfigurationsResponseBodySource
> = z.nativeEnum(GetConfigurationsResponseBodySource);

/** @internal */
export const GetConfigurationsResponseBodyType$: z.ZodNativeEnum<
    typeof GetConfigurationsResponseBodyType
> = z.nativeEnum(GetConfigurationsResponseBodyType);

/** @internal */
export const Added$: z.ZodNativeEnum<typeof Added> = z.nativeEnum(Added);

/** @internal */
export const Upgraded$: z.ZodNativeEnum<typeof Upgraded> = z.nativeEnum(Upgraded);
...
/** @internal */
export const GetConfigurationsResponseBodyDisabledReason$: z.ZodNativeEnum<
    typeof GetConfigurationsResponseBodyDisabledReason
> = z.nativeEnum(GetConfigurationsResponseBodyDisabledReason);

/** @internal */
export const InstallationType$: z.ZodNativeEnum<typeof InstallationType> =
...
export namespace GetConfigurationsResponseBody1$ {
    export const inboundSchema: z.ZodType<GetConfigurationsResponseBody1, z.ZodTypeDef, unknown> = z
        .object({
            ...
            ownerId: z.string(),
            projects: z.array(z.string()).optional(),
            source: GetConfigurationsResponseBodySource$.optional(),
            removedLogDrainsAt: z.number().optional(),
            removedProjectEnvsAt: z.number().optional(),
            removedTokensAt: z.number().optional(),
            removedWebhooksAt: z.number().optional(),
            ...
            disabledAt: z.number().optional(),
            deletedAt: z.nullable(z.number()).optional(),
            disabledReason: GetConfigurationsResponseBodyDisabledReason$.optional(),
            northstarMigratedAt: z.number().optional(),
