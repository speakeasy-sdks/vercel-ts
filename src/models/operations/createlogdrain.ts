...
/** @internal */
export const DeliveryFormat$: z.ZodNativeEnum<typeof DeliveryFormat> = z.nativeEnum(DeliveryFormat);

/** @internal */
export const Sources$: z.ZodNativeEnum<typeof Sources> = z.nativeEnum(Sources);

/** @internal */
export const Environments$: z.ZodNativeEnum<typeof Environments> = z.nativeEnum(Environments);
...
export namespace CreateLogDrainRequestBody$ {
    export const inboundSchema: z.ZodType<CreateLogDrainRequestBody, z.ZodTypeDef, unknown> = z
        .object({
            ...
            deliveryFormat: DeliveryFormat$.optional(),
            url: z.string(),
...
/** @internal */
export const CreateLogDrainDeliveryFormat$: z.ZodNativeEnum<typeof CreateLogDrainDeliveryFormat> =
    z.nativeEnum(CreateLogDrainDeliveryFormat);

/** @internal */
export const CreateLogDrainSources$: z.ZodNativeEnum<typeof CreateLogDrainSources> =
    z.nativeEnum(CreateLogDrainSources);

/** @internal */
export const CreateLogDrainCreatedFrom$: z.ZodNativeEnum<typeof CreateLogDrainCreatedFrom> =
    z.nativeEnum(CreateLogDrainCreatedFrom);

/** @internal */
export const CreateLogDrainEnvironments$: z.ZodNativeEnum<typeof CreateLogDrainEnvironments> =
...
export namespace CreateLogDrainResponseBody$ {
    export const inboundSchema: z.ZodType<CreateLogDrainResponseBody, z.ZodTypeDef, unknown> = z
        .object({
            ...
            createdAt: z.number(),
            id: z.string(),
            deliveryFormat: CreateLogDrainDeliveryFormat$.optional(),
            name: z.string(),
            ownerId: z.string(),
            projectId: z.nullable(z.string()).optional(),
            projectIds: z.array(z.string()).optional(),
            url: z.string(),
            sources: z.array(CreateLogDrainSources$).optional(),
            createdFrom: CreateLogDrainCreatedFrom$.optional(),
            headers: z.record(z.string()).optional(),
            environments: z.array(CreateLogDrainEnvironments$),
