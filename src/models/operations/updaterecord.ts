...
/** @internal */
export const UpdateRecordType$: z.ZodNativeEnum<typeof UpdateRecordType> =
...
export namespace UpdateRecordRequestBody$ {
    export const inboundSchema: z.ZodType<UpdateRecordRequestBody, z.ZodTypeDef, unknown> = z
        .object({
            ...
            type: z.nullable(UpdateRecordType$).optional(),
...
/** @internal */
export const RecordType$: z.ZodNativeEnum<typeof RecordType> = z.nativeEnum(RecordType);

/** @internal */
export const UpdateRecordDnsType$: z.ZodNativeEnum<typeof UpdateRecordDnsType> =
