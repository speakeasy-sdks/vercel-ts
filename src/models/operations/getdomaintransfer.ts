...
/** @internal */
export const TransferPolicy$: z.ZodNativeEnum<typeof TransferPolicy> = z.nativeEnum(TransferPolicy);

/** @internal */
export const GetDomainTransferStatus$: z.ZodNativeEnum<typeof GetDomainTransferStatus> =
...
export namespace GetDomainTransferResponseBody$ {
    export const inboundSchema: z.ZodType<GetDomainTransferResponseBody, z.ZodTypeDef, unknown> = z
        .object({
            ...
            transferPolicy: z.nullable(TransferPolicy$),
            reason: z.string(),
            status: GetDomainTransferStatus$,
        })
        .transform((v) => {
