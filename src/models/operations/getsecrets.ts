...
export type GetSecretsResponse = {
     ...
     * Successful response retrieving a list of secrets.
     */
    object?: GetSecretsResponseBody | undefined;
};
...
export namespace Secrets$ {
    export const inboundSchema: z.ZodType<Secrets, z.ZodTypeDef, unknown> = z
        .object({
            created: z
                .string()
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Secrets> = z
        .object({
...
/** @internal */
export namespace GetSecretsResponse$ {
    export const inboundSchema: z.ZodType<GetSecretsResponse, z.ZodTypeDef, unknown> = z
        .object({
            HttpMeta: components.HTTPMetadata$.inboundSchema,
            object: z.lazy(() => GetSecretsResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
                httpMeta: v.HttpMeta,
    ...
    export type Outbound = {
        ...
        object?: GetSecretsResponseBody$.Outbound | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetSecretsResponse> = z
        .object({
            httpMeta: components.HTTPMetadata$.outboundSchema,
            object: z.lazy(() => GetSecretsResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                HttpMeta: v.httpMeta,
