...
export type EditProjectEnvResponse = {
     ...
     * The environment variable was successfully edited
     */
    object?: EditProjectEnvResponseBody | undefined;
};

/** @internal */
export const EditProjectEnvTarget$: z.ZodNativeEnum<typeof EditProjectEnvTarget> =
    z.nativeEnum(EditProjectEnvTarget);

/** @internal */
export const EditProjectEnvType$: z.ZodNativeEnum<typeof EditProjectEnvType> =
...
export namespace EditProjectEnvRequestBody$ {
    export const inboundSchema: z.ZodType<EditProjectEnvRequestBody, z.ZodTypeDef, unknown> = z
        .object({
            ...
            target: z.array(EditProjectEnvTarget$).optional(),
            gitBranch: z.nullable(z.string()).optional(),
            type: EditProjectEnvType$.optional(),
...
/** @internal */
export const EditProjectEnvTarget2$: z.ZodNativeEnum<typeof EditProjectEnvTarget2> =
    z.nativeEnum(EditProjectEnvTarget2);

/** @internal */
export const EditProjectEnvTarget1$: z.ZodNativeEnum<typeof EditProjectEnvTarget1> =
...
export namespace EditProjectEnvProjectsTarget$ {
    export const inboundSchema: z.ZodType<EditProjectEnvProjectsTarget, z.ZodTypeDef, unknown> =
        z.union([z.array(EditProjectEnvTarget1$), EditProjectEnvTarget2$]);

    export type Outbound = Array<EditProjectEnvTarget1> | EditProjectEnvTarget2;
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, EditProjectEnvProjectsTarget> =
        z.union([z.array(EditProjectEnvTarget1$), EditProjectEnvTarget2$]);
}

/** @internal */
export const EditProjectEnvProjectsType$: z.ZodNativeEnum<typeof EditProjectEnvProjectsType> =
    z.nativeEnum(EditProjectEnvProjectsType);

/** @internal */
export const EditProjectEnvContentHintProjectsResponse200ApplicationJSONResponseBody14Type$: z.ZodNativeEnum<
...
/** @internal */
export const EditProjectEnvContentHintProjectsResponse200ApplicationJSONResponseBody13Type$: z.ZodNativeEnum<
...
/** @internal */
export const EditProjectEnvContentHintProjectsResponse200ApplicationJSONResponseBody12Type$: z.ZodNativeEnum<
...
/** @internal */
export const EditProjectEnvContentHintProjectsResponse200ApplicationJSONResponseBody11Type$: z.ZodNativeEnum<
...
/** @internal */
export const EditProjectEnvContentHintProjectsResponse200ApplicationJSONResponseBody10Type$: z.ZodNativeEnum<
...
/** @internal */
export const EditProjectEnvContentHintProjectsResponse200ApplicationJSONResponseBody9Type$: z.ZodNativeEnum<
...
/** @internal */
export const EditProjectEnvContentHintProjectsResponse200ApplicationJSONResponseBody8Type$: z.ZodNativeEnum<
...
/** @internal */
export const EditProjectEnvContentHintProjectsResponse200ApplicationJSONResponseBodyType$: z.ZodNativeEnum<
...
/** @internal */
export const EditProjectEnvContentHintProjectsResponse200ApplicationJSONType$: z.ZodNativeEnum<
...
/** @internal */
export const EditProjectEnvContentHintProjectsResponse200Type$: z.ZodNativeEnum<
...
/** @internal */
export const EditProjectEnvContentHintProjectsResponseType$: z.ZodNativeEnum<
...
/** @internal */
export const EditProjectEnvContentHintProjectsType$: z.ZodNativeEnum<
...
/** @internal */
export const EditProjectEnvContentHintType$: z.ZodNativeEnum<typeof EditProjectEnvContentHintType> =
...
/** @internal */
export const ContentHintType$: z.ZodNativeEnum<typeof ContentHintType> =
...
/** @internal */
export const EditProjectEnvProjectsResponseType$: z.ZodNativeEnum<
...
export namespace EditProjectEnvResponseBody$ {
    export const inboundSchema: z.ZodType<EditProjectEnvResponseBody, z.ZodTypeDef, unknown> = z
        .object({
            target: z.union([z.array(EditProjectEnvTarget1$), EditProjectEnvTarget2$]).optional(),
            type: EditProjectEnvProjectsType$,
...
/** @internal */
export namespace EditProjectEnvResponse$ {
    export const inboundSchema: z.ZodType<EditProjectEnvResponse, z.ZodTypeDef, unknown> = z
        .object({
            HttpMeta: components.HTTPMetadata$.inboundSchema,
            object: z.lazy(() => EditProjectEnvResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
                httpMeta: v.HttpMeta,
    ...
    export type Outbound = {
        ...
        object?: EditProjectEnvResponseBody$.Outbound | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, EditProjectEnvResponse> = z
        .object({
            httpMeta: components.HTTPMetadata$.outboundSchema,
            object: z.lazy(() => EditProjectEnvResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                HttpMeta: v.httpMeta,
