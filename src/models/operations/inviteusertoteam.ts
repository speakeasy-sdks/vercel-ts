...
export type InviteUserToTeamResponse = {
     ...
     * The member was successfully added to the team
     */
    oneOf?: InviteUserToTeamResponseBody2 | InviteUserToTeamResponseBody1 | undefined;
};
...
export namespace InviteUserToTeamRequestBody$ {
    export const inboundSchema: z.ZodType<InviteUserToTeamRequestBody, z.ZodTypeDef, unknown> = z
        .object({
            ...
            role: Role$.inboundSchema.default(Role.Member),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, InviteUserToTeamRequestBody> = z
        .object({
            uid: z.string().optional(),
            email: z.string().optional(),
            role: Role$.outboundSchema.default(Role.Member),
...
/** @internal */
export namespace InviteUserToTeamResponse$ {
    export const inboundSchema: z.ZodType<InviteUserToTeamResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, InviteUserToTeamResponse> = z
        .object({
