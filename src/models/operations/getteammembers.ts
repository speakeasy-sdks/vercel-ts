...
/** @internal */
export const QueryParamRole$: z.ZodNativeEnum<typeof QueryParamRole> = z.nativeEnum(QueryParamRole);
...
/** @internal */
export const GetTeamMembersRole$: z.ZodNativeEnum<typeof GetTeamMembersRole> =
    z.nativeEnum(GetTeamMembersRole);

/** @internal */
export const GetTeamMembersOrigin$: z.ZodNativeEnum<typeof GetTeamMembersOrigin> =
...
/** @internal */
export const GetTeamMembersTeamsRole$: z.ZodNativeEnum<typeof GetTeamMembersTeamsRole> =
...
export namespace GetTeamMembersProjects$ {
    export const inboundSchema: z.ZodType<GetTeamMembersProjects, z.ZodTypeDef, unknown> = z
        .object({
            ...
            role: GetTeamMembersTeamsRole$.optional(),
        })
        .transform((v) => {
            return {
...
/** @internal */
export const GetTeamMembersEmailInviteCodesRole$: z.ZodNativeEnum<
    typeof GetTeamMembersEmailInviteCodesRole
> = z.nativeEnum(GetTeamMembersEmailInviteCodesRole);

/** @internal */
export const GetTeamMembersEmailInviteCodesProjects$: z.ZodNativeEnum<
...
export namespace EmailInviteCodes2$ {
    export const inboundSchema: z.ZodType<EmailInviteCodes2, z.ZodTypeDef, unknown> = z
        .object({
            ...
            role: GetTeamMembersEmailInviteCodesRole$.optional(),
            isDSyncUser: z.boolean(),
            createdAt: z.number().optional(),
            expired: z.boolean().optional(),
            projects: z.record(GetTeamMembersEmailInviteCodesProjects$).optional(),
        })
        .transform((v) => {
            return {
...
/** @internal */
export const EmailInviteCodesRole$: z.ZodNativeEnum<typeof EmailInviteCodesRole> =
    z.nativeEnum(EmailInviteCodesRole);

/** @internal */
export const EmailInviteCodesProjects$: z.ZodNativeEnum<typeof EmailInviteCodesProjects> =
...
export namespace EmailInviteCodes1$ {
    export const inboundSchema: z.ZodType<EmailInviteCodes1, z.ZodTypeDef, unknown> = z
        .object({
            id: z.string(),
            email: z.string().optional(),
            role: EmailInviteCodesRole$.optional(),
            isDSyncUser: z.boolean(),
            createdAt: z.number().optional(),
            expired: z.boolean().optional(),
            projects: z.record(EmailInviteCodesProjects$).optional(),
        })
        .transform((v) => {
            return {
                id: v.id,
