...
export type GetProjectMembersResponse = {
     ...
     * Paginated list of members for the project.
     */
    oneOf?: GetProjectMembersResponseBody1 | GetProjectMembersResponseBody2 | undefined;
};
...
/** @internal */
export const GetProjectMembersResponseBodyRole$: z.ZodNativeEnum<
    typeof GetProjectMembersResponseBodyRole
> = z.nativeEnum(GetProjectMembersResponseBodyRole);

/** @internal */
export const ComputedProjectRole$: z.ZodNativeEnum<typeof ComputedProjectRole> =
    z.nativeEnum(ComputedProjectRole);

/** @internal */
export const TeamRole$: z.ZodNativeEnum<typeof TeamRole> = z.nativeEnum(TeamRole);
...
/** @internal */
export namespace GetProjectMembersResponse$ {
    export const inboundSchema: z.ZodType<GetProjectMembersResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetProjectMembersResponse> = z
        .object({
