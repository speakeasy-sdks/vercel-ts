...
/** @internal */
export const Event$: z.ZodNativeEnum<typeof Event> = z.nativeEnum(Event);
...
export namespace RecordEventsResponse$ {
    export const inboundSchema: z.ZodType<RecordEventsResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, RecordEventsResponse> = z
        .object({
