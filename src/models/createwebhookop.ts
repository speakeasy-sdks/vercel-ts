...
export namespace CreateWebhookRequestBody$ {
    export const inboundSchema: z.ZodType<CreateWebhookRequestBody, z.ZodTypeDef, unknown> =
        z.object({
            url: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateWebhookRequestBody> =
        z.object({
            url: z.string(),
...
export namespace CreateWebhookEvents$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CreateWebhookEvents> =
        z.nativeEnum(CreateWebhookEvents);
    export const outboundSchema: z.ZodNativeEnum<typeof CreateWebhookEvents> = inboundSchema;
}

/** @internal */
export namespace CreateWebhookResponseBody$ {
    export const inboundSchema: z.ZodType<CreateWebhookResponseBody, z.ZodTypeDef, unknown> =
        z.object({
            secret: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateWebhookResponseBody> =
        z.object({
            secret: z.string(),
