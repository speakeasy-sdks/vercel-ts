...
/** @internal */
export const UpdateAccessGroupRole$inboundSchema: z.ZodNativeEnum<typeof UpdateAccessGroupRole> =
    z.nativeEnum(UpdateAccessGroupRole);

/** @internal */
export const UpdateAccessGroupRole$outboundSchema: z.ZodNativeEnum<typeof UpdateAccessGroupRole> =
...
> = z.object({
    ...
    projects: z.array(z.lazy(() => UpdateAccessGroupProjects$inboundSchema)).optional(),
...
> = z.object({
    name: z.string().optional(),
    projects: z.array(z.lazy(() => UpdateAccessGroupProjects$outboundSchema)).optional(),
    membersToAdd: z.array(z.string()).optional(),
    membersToRemove: z.array(z.string()).optional(),
});
