...
export namespace ListAccessGroupProjectsPagination$ {
    ...
    export const outboundSchema = ListAccessGroupProjectsPagination$outboundSchema;
...
export namespace ListAccessGroupProjectsResponseBody$ {
    ...
    export const inboundSchema = ListAccessGroupProjectsResponseBody$inboundSchema;
    /** @deprecated use `ListAccessGroupProjectsResponseBody$outboundSchema` instead. */
    export const outboundSchema = ListAccessGroupProjectsResponseBody$outboundSchema;
