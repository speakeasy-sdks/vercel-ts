 ...
 */
export type GetConfigurationsResponseBody = One | Array<Two>;
...
export namespace GetConfigurationsResponseBody$ {
    export const inboundSchema: z.ZodType<GetConfigurationsResponseBody, z.ZodTypeDef, unknown> =
        z.union([z.lazy(() => One$.inboundSchema), z.array(z.lazy(() => Two$.inboundSchema))]);

    export type Outbound = One$.Outbound | Array<Two$.Outbound>;
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetConfigurationsResponseBody> =
        z.union([z.lazy(() => One$.outboundSchema), z.array(z.lazy(() => Two$.outboundSchema))]);
}
...
export namespace GetConfigurationsResponse$ {
    ...
    export type Outbound = {
        ...
        oneOf?: One$.Outbound | Array<Two$.Outbound> | undefined;
    };
