...
export class Integrations extends ClientSDK {
    ...
    async list(
        ...
        const [result$] = await this.matcher<operations.GetConfigurationsResponse>()
            .json(200, operations.GetConfigurationsResponse$, { key: "oneOf" })
    ...
    async get(
        ...
        const [result$] = await this.matcher<operations.GetConfigurationResponse>()
            .json(200, operations.GetConfigurationResponse$, { key: "oneOf" })
    ...
    async deleteConfiguration(
        ...
        const [result$] = await this.matcher<operations.DeleteConfigurationResponse>()
            .void(204, operations.DeleteConfigurationResponse$)
            .fail([400, 401, 403, 404, "4XX", "5XX"])
            .match(response, request$, { extraFields: responseFields$ });
    ...
    async listGitNamespaces(
        ...
        const [result$] = await this.matcher<operations.GitNamespacesResponse>()
            .json(200, operations.GitNamespacesResponse$, { key: "responseBodies" })
    ...
    async listGitRepos(
        ...
        const [result$] = await this.matcher<operations.ListGitReposResponse>()
            .json(200, operations.ListGitReposResponse$, { key: "object" })
            .fail([400, 403, "4XX", "5XX"])
            .match(response, request$, { extraFields: responseFields$ });
