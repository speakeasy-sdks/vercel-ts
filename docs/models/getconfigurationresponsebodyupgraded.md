...
```typescript
import { GetConfigurationResponseBodyUpgraded } from "@simplesagar/vercel/models/getconfigurationop.js";

let value: GetConfigurationResponseBodyUpgraded = "read-write:domain";
```
