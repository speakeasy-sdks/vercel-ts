...
export class Checks extends ClientSDK {
    ...
    async create(
        ...
        const [result$] = await this.matcher<operations.CreateCheckResponse>()
            .json(200, operations.CreateCheckResponse$, { key: "object" })
    ...
    async getAll(
        ...
        const [result$] = await this.matcher<operations.GetAllChecksResponse>()
            .json(200, operations.GetAllChecksResponse$, { key: "object" })
            .fail([400, 401, 403, 404, "4XX", "5XX"])
            .match(response, request$, { extraFields: responseFields$ });
    ...
    async get(
        ...
        const [result$] = await this.matcher<operations.GetCheckResponse>()
            .json(200, operations.GetCheckResponse$, { key: "object" })
            .fail([400, 401, 403, 404, "4XX", "5XX"])
            .match(response, request$, { extraFields: responseFields$ });
    ...
    async update(
        ...
        const [result$] = await this.matcher<operations.UpdateCheckResponse>()
            .json(200, operations.UpdateCheckResponse$, { key: "object" })
    ...
    async rerequest(
        ...
        const [result$] = await this.matcher<operations.RerequestCheckResponse>()
            .json(200, operations.RerequestCheckResponse$, { key: "object" })
            .fail([400, 401, 403, 404, "4XX", "5XX"])
            .match(response, request$, { extraFields: responseFields$ });
