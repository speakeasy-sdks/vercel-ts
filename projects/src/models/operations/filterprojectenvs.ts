...
export type Envs = {
    ...
    type?: FilterProjectEnvsResponseBodyProjectsType | undefined;
    id?: string | undefined;
    key?: string | undefined;
    value?: string | undefined;
    configurationId?: string | null | undefined;
...
export type ResponseBodyTarget = Array<FilterProjectEnvsTarget1> | FilterProjectEnvsTarget2;
 ...
 * The list of environment variables for the given project
 */
export type FilterProjectEnvsResponseBody = Three | ResponseBody2 | ResponseBody1;
...
export type FilterProjectEnvsResponse = {
     ...
     * The list of environment variables for the given project
     */
    oneOf?: Three | ResponseBody2 | ResponseBody1 | undefined;
};
    ...
    export const inboundSchema: z.ZodType<Envs, z.ZodTypeDef, unknown> = z
        .object({
            target: z
                ...
                .optional(),
            type: FilterProjectEnvsResponseBodyProjectsType$.inboundSchema.optional(),
            id: z.string().optional(),
            key: z.string().optional(),
            value: z.string().optional(),
            configurationId: z.nullable(z.string()).optional(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Envs> = z
        .object({
            target: z
                ...
                .optional(),
            type: FilterProjectEnvsResponseBodyProjectsType$.outboundSchema.optional(),
            id: z.string().optional(),
            key: z.string().optional(),
            value: z.string().optional(),
            configurationId: z.nullable(z.string()).optional(),
...
export namespace ResponseBodyTarget$ {
    export const inboundSchema: z.ZodType<ResponseBodyTarget, z.ZodTypeDef, unknown> = z.union([
        z.array(FilterProjectEnvsTarget1$.inboundSchema),
        FilterProjectEnvsTarget2$.inboundSchema,
    ]);

    export type Outbound = Array<string> | string;
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ResponseBodyTarget> = z.union([
...
export namespace FilterProjectEnvsResponseBody$ {
    ...
    export type Outbound = Three$.Outbound | ResponseBody2$.Outbound | ResponseBody1$.Outbound;
...
export namespace FilterProjectEnvsResponse$ {
    ...
    export type Outbound = {
        ...
        oneOf?: Three$.Outbound | ResponseBody2$.Outbound | ResponseBody1$.Outbound | undefined;
    };
